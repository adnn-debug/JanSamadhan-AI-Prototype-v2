...
(function(){
  ...
  function ensureStyle(){
    ...
    style.id=STYLE_ID;
    style.textContent=".js-live-clock{display:inline-flex;align-items:center;gap:10px;min-height:38px;padding:7px 12px;border:2px solid #067647;border-radius:9px;background:#12b76a;color:#fff;white-space:nowrap;font-variant-numeric:tabular-nums;box-shadow:0 0 0 2px rgba(18,183,106,.18),0 4px 14px rgba(6,118,71,.28)}.js-live-clock-date{font-size:.72rem;color:#fff;font-weight:800;text-shadow:0 1px 1px rgba(0,0,0,.18)}.js-live-clock-time{font-size:1rem;letter-spacing:.035em;color:#fff;font-weight:950;text-shadow:0 1px 2px rgba(0,0,0,.28)}.js-live-clock-live{display:inline-flex;align-items:center;gap:5px;font-size:.61rem;font-weight:950;color:#fff;letter-spacing:.075em;text-shadow:0 1px 1px rgba(0,0,0,.16)}.js-live-clock-live:before{content:\"\";width:7px;height:7px;border-radius:50%;background:#faff00;box-shadow:0 0 0 3px rgba(250,255,0,.18),0 0 8px rgba(250,255,0,.7)}.apphead .js-live-clock,.utility-right .js-live-clock{background:#12b76a;border-color:#067647}@media(max-width:720px){.js-live-clock{gap:7px;padding:6px 9px}.js-live-clock-date{font-size:.66rem}.js-live-clock-time{font-size:.88rem}.js-live-clock-live{display:none}}@media(max-width:480px){.apphead .js-live-clock{flex-wrap:wrap;gap:2px 7px;max-width:190px;line-height:1.15}.apphead .js-live-clock-date{font-size:.61rem}.apphead .js-live-clock-time{font-size:.82rem}}";
