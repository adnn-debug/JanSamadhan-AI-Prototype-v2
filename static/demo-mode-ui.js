...
(function(){
  ...
  function ensureStyle(){
    ...
    style.id=STYLE_ID;
    style.textContent=".js-live-clock{display:inline-flex;align-items:center;gap:9px;min-height:32px;padding:5px 9px;border:1px solid var(--forest-dark,#03442b);border-radius:8px;background:var(--forest,#075b3a);color:#fff;white-space:nowrap;font-variant-numeric:tabular-nums;box-shadow:0 2px 8px rgba(2,53,34,.16)}.js-live-clock-date{font-size:.68rem;color:rgba(255,255,255,.86);font-weight:700}.js-live-clock-time{font-size:.82rem;letter-spacing:.025em;color:#fff;font-weight:900}.js-live-clock-live{display:inline-flex;align-items:center;gap:4px;font-size:.58rem;font-weight:900;color:#fff;letter-spacing:.06em}.js-live-clock-live:before{content:\"\";width:6px;height:6px;border-radius:50%;background:#fff;box-shadow:0 0 0 3px rgba(255,255,255,.18)}.apphead .js-live-clock,.utility-right .js-live-clock{background:var(--forest,#075b3a);border-color:var(--forest-dark,#03442b)}@media(max-width:720px){.js-live-clock{gap:6px;padding:5px 7px}.js-live-clock-date{font-size:.61rem}.js-live-clock-time{font-size:.73rem}.js-live-clock-live{display:none}}@media(max-width:480px){.apphead .js-live-clock{flex-wrap:wrap;gap:2px 6px;max-width:180px;line-height:1.15}.apphead .js-live-clock-date{font-size:.58rem}.apphead .js-live-clock-time{font-size:.7rem}}";
